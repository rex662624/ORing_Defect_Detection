namespace UnionAoi
{
	partial class ImageProcessing_DefectSetting
	{
		...
		private void InitializeComponent()
		{
			...
			// Stop1
			// 
			this.Stop1.Controls.Add(this.label7);
			this.Stop1.Controls.Add(this.Stop1_arclength_area_ratio);
			this.Stop1.Controls.Add(this.label6);
			this.Stop1.Controls.Add(this.Stop1_min_inner_defect_size);
			...
			this.Stop1_checkbox.Location = new System.Drawing.Point(274, 2);
			...
			// 
			this.Stop1_ignore_inner_circle.Location = new System.Drawing.Point(134, 108);
			...
			// 
			this.Stop1_max_outer_defect.Location = new System.Drawing.Point(14, 47);
			...
			// 
			this.Stop1_min_outer_defect.Location = new System.Drawing.Point(262, 47);
			...
			// Stop2
			// 
			this.Stop2.Controls.Add(this.label8);
			this.Stop2.Controls.Add(this.label3);
			this.Stop2.Controls.Add(this.Stop2_arclength_area_ratio);
			this.Stop2.Controls.Add(this.label9);
			this.Stop2.Controls.Add(this.Stop2_ignore_inner_circle);
			this.Stop2.Controls.Add(this.Stop2_min_inner_defect_size);
			...
			// 
			this.Stop2_min_outer_defect.Location = new System.Drawing.Point(262, 49);
			...
			// 
			this.Stop2_max_outer_defect.Location = new System.Drawing.Point(14, 49);
			...
			// Stop4_min_area
			// 
			this.Stop4_min_area.Location = new System.Drawing.Point(230, 60);
			...
			// Stop4_max_area
			// 
			this.Stop4_max_area.Location = new System.Drawing.Point(14, 60);
		...
		private System.Windows.Forms.TextBox Stop1_arclength_area_ratio;
		private System.Windows.Forms.Label label6;
		private System.Windows.Forms.TextBox Stop1_min_inner_defect_size;
		private System.Windows.Forms.Label label8;
		private System.Windows.Forms.TextBox Stop2_arclength_area_ratio;
